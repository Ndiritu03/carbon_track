        ...
        <div className="mt-12 grid grid-cols-1 gap-12 lg:grid-cols-2">
          <div className="space-y-4">
            ...
            <p className="text-lg text-gray-700">
              At [Your Company Name], we are committed to empowering individuals and businesses to take control of their environmental impact. By offering a platform for precise carbon footprint tracking and actionable insights, we aim to build a more sustainable future.
            </p>
            <p className="text-lg text-gray-700">

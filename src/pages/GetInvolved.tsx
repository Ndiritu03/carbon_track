  ...
  return (
    <div className="h-screen relative getInvolved text-white min-h-screen flex items-center justify-center p-6">
      <div className="text-center">
        <h1 className="text-4xl font-extrabold text-gray-100">How You Can Get Involved</h1>
        <p className="mt-4 text-lg text-gray-800 max-w-2xl mx-auto">
          Here are some ways you can take action:
        </p>
        <ul className="mt-6 list-disc text-lg text-gray-800 max-w-2xl fondt-semi-bold mx-auto space-y-4">
